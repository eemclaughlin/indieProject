...
public class UserDao {
    ...
    public User getById(int id) {
        Session session = sessionFactory.openSession();
        // For id search, all you need is this.  Not all the extra stuff.  Built in.
     ...
     * sample usage: getByPropertyEqual("userName", "Carrot Cake")
     *
     ...
     * sample usage: getByPropertyLike("userName", "Carrot Cake")
     *
     * @param propertyName entity property to search by
     * @param value value of the property to search for
     * @return list of orders meeting the criteria search
