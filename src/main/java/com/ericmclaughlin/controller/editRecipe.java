...
public class editRecipe extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            // This stuff related to the cookbook dropdown menu and what was selected by default.
            // Get the cookbook from the recipe.
            //int cookbookId = editRecipe.getCookbooks().getCookbookId();
            //logger.debug("The cookbook id is: " + cookbookId);

            // Get the cookbook from the database based on id
            //Cookbook editCookbook = (Cookbook) cookbookDao.getById(cookbookId);

            // Set the cookbooks back into the session.
            //req.setAttribute("editCookbook", editCookbook);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // Get the recipe id from the session.
        // int recipeId = Integer.parseInt(req.getParameter("recipeId"));
        logger.debug("The recipe id in the POST SECTION is: " + recipeId);
